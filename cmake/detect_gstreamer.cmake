...
#    PATH_SUFFIXES "lib")
  ...
  find_library(GSTREAMER_rtspserver_LIBRARY
  ...
  if(GSTREAMER_gst_INCLUDE_DIR
      ...
      AND GSTREAMER_rtsp_LIBRARY
      AND GSTREAMER_rtspserver_LIBRARY
      )
...
#  ocv_check_modules(GSTREAMER_pbutils gstreamer-pbutils-1.0)
  if(GSTREAMER_base_FOUND AND GSTREAMER_app_FOUND)
    set(HAVE_GSTREAMER TRUE)
    set(GSTREAMER_VERSION ${GSTREAMER_base_VERSION}) # informational
    set(GSTREAMER_LIBRARIES ${GSTREAMER_base_LIBRARIES} ${GSTREAMER_app_LIBRARIES})
    set(GSTREAMER_INCLUDE_DIRS ${GSTREAMER_base_INCLUDE_DIRS} ${GSTREAMER_app_INCLUDE_DIRS})
  endif()
endif()
